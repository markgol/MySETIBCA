...
// 
//  This module is a copy of the DisplayDlg module used in MySETIviewer and customized
...
INT_PTR CALLBACK SettingsDisplayDlg(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_COMMAND:
        ...
        case IDOK:
        {
            ...
            if (IsDlgButtonChecked(hDlg, IDC_ENABLE) == BST_CHECKED) {
                WritePrivateProfileString(L"SettingsDisplayDlg", L"EnableGrid", L"1", (LPCTSTR)strAppNameINI);
            }
            else {
                WritePrivateProfileString(L"SettingsDisplayDlg", L"EnableGrid", L"0", (LPCTSTR)strAppNameINI);
            }
