...
// and convert it into a image file that can be directly used by the
// collection of the MySETI applications
//
//  This module is a copy of the BinaryInput module used in MySETIviewer and customized
...
INT_PTR CALLBACK BitImageDlg(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_COMMAND:
        ...
        case IDC_CONVERT:
        {
            ...
            if (iRes != APP_SUCCESS) {
                MessageMySETIBCAError(hDlg, iRes, L"Convert");
                return (INT_PTR)TRUE;
            }
