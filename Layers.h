#pragma once
//
// MySETIBCA, a set tools for decoding bitstreams into various formats and manipulating those files
// Layers.h
// (C) 2023, Mark Stegall
// Author: Mark Stegall
//
...
private:
	...
	BOOL Enabled[MAX_LAYERS] = { FALSE,FALSE,FALSE,FALSE,FALSE,FALSE,FALSE,FALSE,FALSE,FALSE,FALSE,FALSE,FALSE,FALSE,FALSE,FALSE,FALSE,FALSE,FALSE,FALSE };
...
public:
	// variables
	WCHAR* LayerFilename[MAX_LAYERS] = { NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL };
